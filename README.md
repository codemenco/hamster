# Hamster Kombat Clone Script | Telegram Game

If you have a desire to launch your own Hamster clone (NotCoin like telegram game), but you are not ready to spend a lot of money & time on the development and further support of the product, then you have come to the right place.

We will help you with product implementation so that you can fully focus on marketing and sales.

![Tapswap Clone GitHub Image](/images/image1.jpg "White Label Hamster Kombat | GitHub")
![Tapswap Source Code GitHub Image](/images/image2.jpg "Web3 Hamster Kombat Package Solution | GitHub")
...
|---------------------|--------------------|---------------|----------------|
| % coins for Codemen | 5%                 | 0%            | 0%             |
| Maintenance Cost    | Free               | $2,000 / year | Free           |
| Community           | -                  | 10000+        | 50000+         |
| Custom design       | Only logo & colors | Yes           | Yes            |
| Pricing             | $1,000            | $2,000       | Contact Us     |

[![Tapmen Telegram with Special Offers](/images/telegram.jpg)](https://t.me/tapper_codemen_bot)
...
- <a href="https://telegram.me/tapper_codemen_bot" target="_blank">Contact Us in Telegram</a>
- <a href="https://codemen.me" target="_blank">Contact Us page</a>
- [Our Email](mailto:codemenco@gmail.com)
...
<details>
  <summary>What is the Hamster Script?</summary>
...
<details>
  <summary>What's the cost of the Hamster Script?</summary>
  <p>Our Tapswap Script is distributed according to the White Label model. We have 3 offers for you:</p> 
  <ul>
      <li>Basic Package - <b>$1,000</b> first payment and 5% of revenue. For these funds, the solution will be adapted for you and deployed on your server. Product maintenance will be free.</li>
      <li>NoFee Package - <b>$2,000</b> first payment and $2,000 per year for maintenance. Suitable if you have a large community and there will be many users from the start.</li>
